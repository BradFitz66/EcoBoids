...
namespace Boids.lib.QuadTree
{
	/// <summary>
	    ...
	    public class QuadTree<T>
	    {
	        ...
	        public this(double x, double y, double width, double height, IQuadTreeObjectBounds<T> objectBounds, int maxObjects = 10, int maxLevel = 5)
	        {


	            MaxObjects = maxObjects;
	            MaxLevel = maxLevel;
	            MainRect =  QuadTreeRect(x, y, width, height);
	            _objectBounds = objectBounds;
	            _rootSector = LeafSector<T>(0, MainRect, objectBounds, maxObjects, maxLevel);
	        }
	        ...
	        /// <param name="maxObjects">The max number of elements in one rectangle. The default is 10.</param>
	        /// <param name="maxLevel">The max depth level. The default is 5. </param>
	        public this(double width, double height, IQuadTreeObjectBounds<T> objectBounds, int maxObjects = 10, int maxLevel = 5)
	        ...
	        {
	            _rootSector.Clear();
	            _rootSector = LeafSector<T>(0, MainRect, _objectBounds, MaxObjects, MaxLevel);
	            ObjectCount = 0;
	        }
	        ...
	        public bool Remove(T obj)
	        {
				...
				Sector<T> collapsed;
	            if (_rootSector.TryCollapse(out collapsed))
	        ...
	        {
	            return _rootSector.GetNearestObjects(obj);
	        }
